      ...
      <CardContent className="space-y-4 p-4 pt-0 sm:space-y-6 sm:p-6 sm:pt-0">
        <div className="grid gap-4 md:grid-cols-3">
          {content.cards.map((card, index) => {
            ...
            return (
              <article key={card.title} className="rounded-2xl border border-border/70 bg-background/65 p-4 sm:p-5">
        ...
        <div className="rounded-2xl border border-border/70 bg-background/65 p-4 sm:p-5">
          ...
          <ol className="list-decimal space-y-2 pl-5 text-sm text-muted-foreground marker:text-primary/70">
            {content.integration_steps.map((step, index) => (
        ...
        <div className="rounded-2xl border border-border/70 bg-secondary/40 p-4 sm:p-5">
          ...
          <pre className="overflow-x-auto whitespace-pre-wrap break-words rounded-xl border border-border/70 bg-background p-3 text-[11px] text-foreground sm:p-4 sm:text-xs">
